...
public abstract class AbstractController implements PropertyChangeListener {
    ...
    // /**
    // * This is a convenience method that subclasses can call upon to fire property
    // changes back to the models. This method uses reflection to inspect each of
    // the model classes to
    // * determine whether it is the owner of the property in question. If it isn't,
    // a NoSuchMethodException is thrown, which the method ignores.
    // *
