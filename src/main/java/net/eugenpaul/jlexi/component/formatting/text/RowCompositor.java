...
public class RowCompositor implements Compositor<TextPaneElement> {
    ...
    @Override
    public List<TextPaneElement> compose(Iterator<TextPaneElement> iterator, int width) {
    ...
    @Override
    public NodeList<TextPaneElement> composeToNodeList(Iterator<TextPaneElement> iterator, int width) {
