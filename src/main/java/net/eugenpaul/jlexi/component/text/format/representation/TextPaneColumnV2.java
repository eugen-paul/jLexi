...
@Slf4j
public class TextPaneColumnV2 extends TextRepresentationOfRepresentationV2 {

    private TreeMap<Integer, TextRepresentationV2> yPositionToRow;

    @Getter
    @Setter
    private Color background;

    public TextPaneColumnV2(Glyph parent) {
        super(parent);
