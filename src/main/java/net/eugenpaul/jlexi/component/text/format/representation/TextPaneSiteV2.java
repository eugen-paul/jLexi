...
@Slf4j
public class TextPaneSiteV2 extends TextRepresentationOfRepresentation {
    ...
    public TextPaneSiteV2(Glyph parent, Size size) {
        super(parent);
        setSize(size);
    ...
    public TextPosition getCursorElementAt(Vector2d pos) {
        ...
        if (clickedElement != null) {
            LOGGER.trace("Site Click on {}: {}.", clickedElement);
        } else {
