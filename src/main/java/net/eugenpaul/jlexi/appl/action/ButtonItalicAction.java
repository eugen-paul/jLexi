...
public class ButtonItalicAction extends ButtonAction implements EventSubscriber {

    private final Button button;
    private final String textCursorName;

    public ButtonItalicAction(Button button, KeyBindingAction action, String textCursorName) {
        super(action);
        this.button = button;
    ...
    public void update(Object source, Object type, Object data) {
        ...
        if (textElement.getFormat().getItalic().booleanValue()) {
